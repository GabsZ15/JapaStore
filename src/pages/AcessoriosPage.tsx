...
export function AcessoriosPage() {
  ...
  const content = settings.siteContent.pages.acessorios;
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <ProductGrid title={content.gridTitle} onTitleChange={(v) => handleUpdate('gridTitle', v)} category="Acessórios" linkText={content.ctaText} onLinkTextChange={(v) => handleUpdate('ctaText', v)} linkTo="/camisetas" layout="grid" />
    </main>
  );
}
