...
export function LancamentosPage() {
  ...
  const content = settings.siteContent.pages.lancamentos;
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <ProductGrid title={content.gridTitle} onTitleChange={(v) => handleUpdate('gridTitle', v)} linkText={content.ctaText} onLinkTextChange={(v) => handleUpdate('ctaText', v)} linkTo="/" layout="grid" />
    </main>
  );
}
